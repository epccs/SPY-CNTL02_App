...
/**
  * @brief This function handles USART2 interrupt (hand-added; HAL_UART_Transmit_IT for DMX1).
  */
...
/**
  * @brief This function handles the combined USART3/USART4 interrupt
  *        (hand-added; HAL_UART_Transmit_IT for DMX2/DMX3).
  */
